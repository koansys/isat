...
(function () {
    ...
    document.getElementById('instruction_button').onclick = function () {
        if (document.getElementById('nav').style.display == 'none') {
            ...
            document.getElementById('instruction_button').style.left = '370px';
            document.getElementById('display_button').style.left = '430px';
            document.getElementById('three_d_display_button').style.left = '430px';
            document.getElementById('columbus_display_button').style.left = '430px';
            document.getElementById('two_d_display_button').style.left = '430px';
            document.getElementById('satellite_button').style.left = '490px';
            document.getElementById('live_data_button').style.left = '550px';
            document.getElementById('bing_data_button').style.left = '550px';
            document.getElementById('osm_data_button').style.left = '550px';
            document.getElementById('static_data_button').style.left = '550px';
            onResize();
        }
        else {
