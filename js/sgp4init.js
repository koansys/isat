/*global getgravc: true, initl: true, dscom: true */
// -----------------------------------------------------------------------------
//
//                              procedure sgp4init
//
...
function sgp4init(whichconst, satrec, xbstar, xecco, epoch,
    ...
    var gravc, tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2,
        ...
        initlvars, ainv, ao, con42, cosio, cosio2, einv, eccsq, omeosq, posq, rp, rteosq, sinio,
    ...
    initlvars = initl(satrec.ecco, epoch, satrec.inclo, satrec.no, satrec.satnum);
    ainv          = initlvars[0];
    ao            = initlvars[1];
    satrec.con41  = initlvars[2];
    con42         = initlvars[3];
    cosio         = initlvars[4];
    cosio2        = initlvars[6];
    einv          = initlvars[7];
    eccsq         = initlvars[8];
    satrec.method = initlvars[9];
    omeosq        = initlvars[10];
    posq          = initlvars[11];
    rp            = initlvars[12];
    rteosq        = initlvars[13];
    sinio         = initlvars[14];
    satrec.gsto   = initlvars[15];
    satrec.no     = initlvars[16];
    ...
    if ((2 * Math.PI / satrec.no) >= 225.0) {
        ...
        dscomvars = dscom(epoch, satrec.ecco, satrec.argpo, tc, satrec.inclo,
                          satrec.nodeo, satrec.no);
        sinim		= dscomvars.shift();
        cosim		= dscomvars.shift();
        sinomm		= dscomvars.shift();
        cosomm		= dscomvars.shift();
        snodm		= dscomvars.shift();
        cnodm		= dscomvars.shift();
        day		= dscomvars.shift();
        satrec.e3	= dscomvars.shift();
        satrec.ee2	= dscomvars.shift();
        em		= dscomvars.shift();
        emsq		= dscomvars.shift();
        gam		= dscomvars.shift();
        satrec.peo	= dscomvars.shift();
        satrec.pgho	= dscomvars.shift();
        satrec.pho	= dscomvars.shift();
        satrec.pinco    = dscomvars.shift();
        satrec.plo      = dscomvars.shift();
        rtemsq          = dscomvars.shift();
        satrec.se2      = dscomvars.shift();
        satrec.se3      = dscomvars.shift();
        satrec.sgh2     = dscomvars.shift();
        satrec.sgh3     = dscomvars.shift();
        satrec.sgh4     = dscomvars.shift();
        satrec.sh2      = dscomvars.shift();
        satrec.sh3      = dscomvars.shift();
        satrec.si2      = dscomvars.shift();
        satrec.si3      = dscomvars.shift();
        satrec.sl2      = dscomvars.shift();
        satrec.sl3      = dscomvars.shift();
        satrec.sl4      = dscomvars.shift();
        s1              = dscomvars.shift();
        s2              = dscomvars.shift();
        s3              = dscomvars.shift();
        s4              = dscomvars.shift();
        ...
        sz2             = dscomvars.shift();
        sz3             = dscomvars.shift();
        sz11            = dscomvars.shift();
        sz12            = dscomvars.shift();
        sz13		= dscomvars.shift();
        sz21            = dscomvars.shift();
        sz22            = dscomvars.shift();
        sz23            = dscomvars.shift();
        sz31            = dscomvars.shift();
        sz32            = dscomvars.shift();
        sz33            = dscomvars.shift();
        satrec.xgh2     = dscomvars.shift();
        satrec.xgh3     = dscomvars.shift();
        satrec.xgh4     = dscomvars.shift();
        satrec.xh2      = dscomvars.shift();
        satrec.xh3      = dscomvars.shift();
        satrec.xi2      = dscomvars.shift();
        satrec.xi3      = dscomvars.shift();
        satrec.xl2      = dscomvars.shift();
        satrec.xl3      = dscomvars.shift();
        satrec.xl4      = dscomvars.shift();
        nm              = dscomvars.shift();
        z1              = dscomvars.shift();
        z2              = dscomvars.shift();
        z3              = dscomvars.shift();
        ...
        z32             = dscomvars.shift();
        z33             = dscomvars.shift();
        satrec.zmol     = dscomvars.shift();
        satrec.zmos     = dscomvars.shift();
