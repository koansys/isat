...
test('six', function () {
    ...
    ok(isequalRel(ecc,          2.71613018453269E-02, TOL_MED),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.66003947074967E-01, TOL),              "incl=" + incl);
    ok(isequalRel(node,         5.46575510473817E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         5.71251383722787E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           5.78173770083516E+00, TOL_BIG),              "nu=" + nu);
    ok(isequalRel(m,            5.80739040934485E+00, TOL_BIG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('eight', function () {
    ...
    ok(isequalRel(ecc,          1.21135191903448E-03, TOL_HUG),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.99964204593395E-01, TOL),              "incl=" + incl);
    ok(isequalRel(node,         6.14349308758867E-01, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.94487413148677E-01, TOL_HUG),              "argp=" + argp);
    ok(isequalRel(nu,           2.41996643803813E-02, TOL_HUG),              "nu=" + nu);
    ok(isequalRel(m,            2.41410946840184E-02, TOL_HUG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twelve', function () {
    ...
    ok(isequalRel(ecc,          2.67519582587339E-02, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.08484314121097E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         1.34977007285450E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.67566470055803E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           5.29018181101701E+00, TOL_BIG),              "nu=" + nu);
    ok(isequalRel(m,            5.33451033639964E+00, TOL_BIG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('fifteen', function () {
    ...
    ok(isequalRel(a,            2.40976786870555E+05, TOL_BIG),              "a=" + a);
    ...
    ok(isequalRel(m,            4.22676817801008E-02, TOL_LAR),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('sixteen', function () {
    ...
    ok(isequalRel(a,            1.55476478683806E+04, TOL_BIG),              "a=" + a);
    ...
    ok(isequalRel(m,            8.31851228715890E-01, TOL_BIG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('seventeen', function () {
    ...
    ok(isequalRel(ecc,          2.65419717085753E-03, TOL_MED),              "ecc=" + ecc);
    ok(isequalRel(incl,         6.74671209805306E-02, TOL),              "incl=" + incl);
    ok(isequalRel(node,         1.39028438166303E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         5.45699452325021E+00, TOL_MED),              "argp=" + argp);
    ok(isequalRel(nu,           1.35505071182642E+00, TOL_HUG),              "nu=" + nu);
    ok(isequalRel(m,            1.34986759643305E+00, TOL_HUG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('eighteen', function () {
    ...
    ok(isequalRel(ecc,          2.12154856171627E-04, TOL_HUG),              "ecc=" + ecc); // ecc=0.00021129876915091614
    ok(isequalRel(incl,         3.18674756783703E-04, TOL),              "incl=" + incl);
    ok(isequalRel(node,         4.59521769510327E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         1.91739538085197E-03, TOL),              "argp=" + argp); // WAY OFF: argp=0.0006239141698295879
    ok(isequalRel(nu,           3.09032602056223E-01, TOL_HUG),              "nu=" + nu); // nu=0.3103260832674437
    ok(isequalRel(m,            3.08903573243272E-01, TOL_HUG),              "m=" + m); // m=0.3101970544834727
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('nineteen', function () {
    ...
    ok(isequalRel(ecc,          3.69979235697233E-04, TOL_HUG),              "ecc=" + ecc); // ecc=0.0003690851896055486
    ok(isequalRel(incl,         2.85976184875877E-04, TOL),              "incl=" + incl);
    ok(isequalRel(node,         4.29080860555824E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         1.85980278064887E+00, TOL_LAR),              "argp=" + argp);
    ok(isequalRel(nu,           6.17851838509859E+00, TOL_MED),              "nu=" + nu);
    ok(isequalRel(m,            6.17859567161117E+00, TOL_MED),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty', function () {
    ...
    ok(isequalRel(a,            2.61234300996053E+04, TOL_BIG),              "a=" + a);
    ok(isequalRel(ecc,          5.60054995788355E-01, TOL_BIG),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.19528893631712E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         4.12099296270288E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         2.16041300156839E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           3.05508631503388E-01, TOL_BIG),              "nu=" + nu);
    ok(isequalRel(m,            7.21813883480142E-02, TOL_BIG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-one', function () {
    ...
    ok(isequalRel(ecc,          7.33409334032739E-04, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.71797065738686E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         4.32447358383434E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         3.31809651394408E+00, TOL_LAR),              "argp=" + argp);
    ok(isequalRel(nu,           4.19527552194476E+00, TOL_LAR),              "nu=" + nu);
    ok(isequalRel(m,            4.19655090054006E+00, TOL_LAR),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-two', function () {
    ...
    ok(isequalRel(ecc,          4.64039318972371E-03, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         9.55169726404771E-01, TOL),              "incl=" + incl);
    ok(isequalRel(node,         5.66861410511826E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.64025630843130E+00, TOL_LAR),              "argp=" + argp);
    ok(isequalRel(nu,           2.68798252791767E+00, TOL_LAR),              "nu=" + nu);
    ok(isequalRel(m,            2.68390280725400E+00, TOL_LAR),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-three', function () {
    ...
    ok(isequalRel(ecc,          1.09306090641488E-03, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.13442716879013E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         6.02608851052386E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.88945444324430E+00, TOL_LAR),              "argp=" + argp);
    ok(isequalRel(nu,           3.75546521730686E+00, TOL_LAR),              "nu=" + nu);
    ok(isequalRel(m,            3.75672534929802E+00, TOL_LAR),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-four', function () {
    ...
    ok(isequalRel(a,            1.73566843011105E+04, TOL_BIG),              "a=" + a);
...
test('twenty-five', function () { // HUGe tolerance isn't enough, tests fail, something wrong
    var rets,
    TOL     = 0.000001,
    TOL_BIG = 0.00001,
    TOL_MED = 0.0001,
    ...
    ok(isequalRel(ecc,          5.25310107819390E-05, TOL_HUG),              "ecc=" + ecc); // ecc=0.000051843432843866426
    ok(isequalRel(incl,         1.36816852635197E-04, TOL),              "incl=" + incl);
    ok(isequalRel(node,         6.10324172654242E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         6.23123980143058E+00, TOL_HUG),              "argp=" + argp); // argp=6.2201511097246085
    ok(isequalRel(nu,           6.94110565399423E-01, TOL_HUG),              "nu=" + nu); // nu=0.7051992571053946
    ok(isequalRel(m,            6.94043359043748E-01, TOL_HUG),              "m=" + m); // m=0.7051320507648183
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-six', function () {
    ...
    ok(isequalRel(ecc,          2.88909806022195E-02, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.68371092952437E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         2.75760784784415E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.24204543369479E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           2.34990431250375E+00, TOL_BIG),              "nu=" + nu);
    ok(isequalRel(m,            2.30815847400074E+00, TOL_BIG),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-seven', function () {
    ...
    ok(isequalRel(ecc,          2.79085159977167E-03, TOL_LAR),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.43856182643222E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         4.77302888470007E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         4.44148635150427E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           3.25119015885888E+00, TOL_MED),              "nu=" + nu);
    ok(isequalRel(m,            3.25180194824909E+00, TOL_MED),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-eight', function () {
    ...
    ok(isequalRel(ecc,          2.08561216527540E-02, TOL_MED),              "ecc=" + ecc);
    ok(isequalRel(incl,         8.99668862904084E-01, TOL),              "incl=" + incl);
    ok(isequalRel(node,         3.72349173970767E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         1.64777009491722E+00, TOL_BIG),              "argp=" + argp);
    ok(isequalRel(nu,           3.85667915538073E-01, TOL_MED),              "nu=" + nu);
    ok(isequalRel(m,            3.70201375854753E-01, TOL_MED),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
...
test('twenty-nine', function () {
    ...
    ok(isequalRel(ecc,          1.05207904776945E-02, TOL_MED),              "ecc=" + ecc);
    ok(isequalRel(incl,         1.27117214865807E+00, TOL),              "incl=" + incl);
    ok(isequalRel(node,         2.02021952954979E+00, TOL),              "node=" + node);
    ok(isequalRel(argp,         1.10890553136213E+00, TOL_MED),              "argp=" + argp);
    ok(isequalRel(nu,           3.84788102737272E+00, TOL_MED),              "nu=" + nu);
    ok(isequalRel(m,            3.86161963098100E+00, TOL_MED),              "m=" + m);
    ok(isequalRel(arglat,       9.99999100000000E+05, TOL),              "arglat=" + arglat);
    ok(isequalRel(truelon,      9.99999100000000E+05, TOL),              "truelon=" + truelon);
    ok(isequalRel(lonper,       9.99999100000000E+05, TOL),              "lonper=" + lonper);
});
