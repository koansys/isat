...
test(' 9.800539401920e-01,  2.103967656036e-02,  3.623303527140e+00, -1.968466918871e-04, -4.620853989286e-05,  9.143969877776e-05,  9.047265431838e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            1.450506000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         2.000636014976e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            5.245868658927e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ok(isequalRel(d2211,         0.000000000000e+00, TOL));
         ok(isequalRel(d3210,         0.000000000000e+00, TOL));
         ok(isequalRel(d3222,         0.000000000000e+00, TOL));
         ok(isequalRel(d4410,         0.000000000000e+00, TOL));
         ok(isequalRel(d4422,         0.000000000000e+00, TOL));
         ok(isequalRel(d5220,         0.000000000000e+00, TOL));
         ok(isequalRel(d5232,         0.000000000000e+00, TOL));
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,         -5.739257257134e-10, TOL));
         ok(isequalRel(didt,         -2.669482583786e-08, TOL));
         ok(isequalRel(dmdt,         -6.045613838815e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -6.171410259572e-08, TOL));
         ok(isequalRel(domdt,         6.528741483006e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
         ok(isequalRel(xlamo,         0.000000000000e+00, TOL));
         ok(isequalRel(xli,           0.000000000000e+00, TOL));
         ok(isequalRel(xni,           0.000000000000e+00, TOL));
     });
// 4632
// 6251

test(' 4.358815257110e-01,  4.729513710532e-01,  4.621022739372e+00, -4.106209626082e-04, -3.776251664788e-05,  5.482975046298e-05,  3.980536524969e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            6.877146000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.119778813470e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.748547019630e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          2.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(dedt,         -2.888547623461e-08, TOL));
         ok(isequalRel(didt,         -9.784108269214e-09, TOL));
         ok(isequalRel(dmdt,          9.270786742527e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -6.124323489695e-08, TOL));
         ok(isequalRel(domdt,        -1.415521073384e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,        -8.753597222054e-03, TOL));
         ok(isequalRel(xlamo,         2.662899525810e+00, TOL));
         ok(isequalRel(xli,           2.662899525810e+00, TOL));
         ok(isequalRel(xni,           8.748547019630e-03, TOL));
     });

// 8195

test(' 4.289855844945e-01,  4.997148204060e-01,  4.712788660783e+00, -4.105604224204e-04, -3.869698011745e-05,  5.474139856001e-05,  3.871905129561e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.069051000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.127426846252e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.762667060363e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          2.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,        -1.223066000340e-11, TOL));
         ...
         ok(isequalRel(d5232,         7.951364509680e-13, TOL));
         ok(isequalRel(d5421,        -2.951741474264e-12, TOL));
         ok(isequalRel(d5433,        -2.267801942329e-12, TOL));
         ok(isequalRel(dedt,         -4.867357573014e-09, TOL));
         ok(isequalRel(didt,         -1.740817385888e-09, TOL));
         ok(isequalRel(dmdt,          7.275290629300e-09, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -8.615750092681e-08, TOL));
         ok(isequalRel(domdt,         2.335815977949e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,        -8.754040087689e-03, TOL));
         ok(isequalRel(xlamo,         2.158241444311e+00, TOL));
         ok(isequalRel(xli,           2.158241444311e+00, TOL));
         ok(isequalRel(xni,           8.762667060363e-03, TOL));
     });

// 9880

test(' 9.862976975087e-01,  7.342528284100e-04,  5.716345999363e+00, -3.844603186866e-05, -4.732890446927e-05,  9.462305117515e-05,  9.458830617460e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            2.709710000000e-02, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.657329751109e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            5.069384722250e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ok(isequalRel(d2211,         0.000000000000e+00, TOL));
         ok(isequalRel(d3210,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,         -2.100861346923e-08, TOL));
         ok(isequalRel(dmdt,         -1.007233935453e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         5.240300896038e-08, TOL));
         ok(isequalRel(domdt,        -2.079390322813e-08, TOL));
         ok(isequalRel(del1,         -1.069242230635e-12, TOL));
         ok(isequalRel(del2,          2.268988798894e-11, TOL));
         ok(isequalRel(del3,          3.478296584410e-12, TOL));
         ok(isequalRel(xfact,        -4.374900909933e-03, TOL));
         ok(isequalRel(xlamo,         2.429222236900e+00, TOL));
         ok(isequalRel(xli,           2.429222236900e+00, TOL));
         ok(isequalRel(xni,           5.069384722250e-03, TOL));
     });

// 9998

test(' 6.846539709542e-01,  5.355365089730e-01,  8.285461931653e-01, -3.598896383932e-04, -3.529408803158e-05,  4.810694202241e-05,  3.278563067952e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.318036000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         8.166674822762e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            9.971131604593e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,          2.638606466889e-08, TOL));
         ok(isequalRel(didt,         -3.476737419877e-08, TOL));
         ok(isequalRel(dmdt,          8.037814258571e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -6.033631306028e-08, TOL));
         ok(isequalRel(domdt,         9.465204016205e-09, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 9.801384832532e-01,  1.336798440000e-06,  4.617827041512e-01, -1.928451076707e-06, -5.559746452923e-05,  1.111948547358e-04,  1.111947804133e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            1.156200000000e-03, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.996377411601e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            4.313874514604e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,          1.917646021027e-08, TOL));
         ok(isequalRel(dmdt,         -1.336452685205e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         6.865572727316e-08, TOL));
         ok(isequalRel(domdt,        -2.094974096530e-08, TOL));
         ok(isequalRel(del1,         -5.401617059180e-13, TOL));
         ok(isequalRel(del2,          1.319183725301e-11, TOL));
         ok(isequalRel(del3,          1.815021571877e-12, TOL));
         ok(isequalRel(xfact,        -4.375061997072e-03, TOL));
         ok(isequalRel(xlamo,         1.954280633142e+00, TOL));
         ok(isequalRel(xli,           1.954280633142e+00, TOL));
         ok(isequalRel(xni,           4.313874514604e-03, TOL));
     });

// 14128

test(' 4.680747993911e-01,  3.131887589093e-01,  4.278836976885e+00, -1.565426252795e-04, -1.357597034132e-05,  2.250191985532e-05,  1.864825807826e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            5.596327000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.083685404539e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            2.131732105901e-02, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,         -2.324540208861e-09, TOL));
         ok(isequalRel(didt,         -9.012956177194e-09, TOL));
         ok(isequalRel(dmdt,          3.250770527931e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -2.039277854983e-08, TOL));
         ok(isequalRel(domdt,        -1.115284366841e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 9.768540719074e-01,  6.184952661581e-01,  3.426128445555e+00, -3.244378761083e-03, -3.604476295552e-04,  4.452686665858e-04,  2.750249539548e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.864447000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         2.155725972308e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            1.077283640185e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,          9.991744175572e-08, TOL));
         ok(isequalRel(didt,         -2.656246157481e-07, TOL));
         ok(isequalRel(dmdt,         -7.442607144689e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -7.900872576398e-07, TOL));
         ok(isequalRel(domdt,         9.925475448625e-07, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 4.667741107229e-01,  5.508148245610e-01,  4.416489349660e+00, -4.075107416397e-04, -4.074643162103e-05,  5.461755872540e-05,  3.660538607241e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.421690000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.085156717098e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.782535528761e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          2.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,        -1.358430480330e-11, TOL));
         ...
         ok(isequalRel(dedt,          1.441546149773e-08, TOL));
         ok(isequalRel(didt,         -1.685608671533e-09, TOL));
         ok(isequalRel(dmdt,          1.948849567720e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -6.831807033508e-09, TOL));
         ok(isequalRel(domdt,        -7.014119890435e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,        -8.754654235733e-03, TOL));
         ok(isequalRel(xlamo,        -2.560712769541e+00, TOL));
         ok(isequalRel(xli,          -2.560712769541e+00, TOL));
         ok(isequalRel(xni,           8.782535528761e-03, TOL));
     });
...
test(' 4.461431438481e-01,  5.687741989094e-01,  4.421379762224e+00, -4.152029536535e-04, -4.255636236536e-05,  5.589164123999e-05,  3.670280290501e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.541712000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.108345161540e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.582332516240e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          2.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5433,        -4.510549332610e-12, TOL));
         ok(isequalRel(dedt,          7.330390566401e-09, TOL));
         ok(isequalRel(didt,         -2.350896248702e-08, TOL));
         ok(isequalRel(dmdt,         -2.726008010046e-09, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -9.800554699737e-08, TOL));
         ok(isequalRel(domdt,         3.479071142642e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,        -8.755049561816e-03, TOL));
         ok(isequalRel(xlamo,         2.409040817745e+00, TOL));
         ok(isequalRel(xli,           2.409040817745e+00, TOL));
         ok(isequalRel(xni,           8.582332516240e-03, TOL));
     });

// 22674

test(' 9.924402794872e-01,  5.268569159708e-01,  5.167015834603e+00, -3.645715464322e-04, -3.538528327605e-05,  4.867981516121e-05,  3.348460411695e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            7.258491000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.230387309486e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            9.853789469239e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,         -1.045444380488e-08, TOL));
         ok(isequalRel(didt,          2.376724085775e-08, TOL));
         ok(isequalRel(dmdt,         -2.642690499755e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -4.838389780477e-07, TOL));
         ok(isequalRel(domdt,         4.812656940526e-07, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 8.767351504117e-01,  9.463978197680e-01,  5.312084111370e-01, -5.081511320759e-03, -3.248271505978e-03,  1.504089035974e-03,  3.482288694116e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            9.728298000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         5.017647066558e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            3.189177226396e-04, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,          2.968135603242e-09, TOL));
         ok(isequalRel(didt,         -3.439044884764e-07, TOL));
         ok(isequalRel(dmdt,         -3.438051105625e-06, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -5.053925231474e-07, TOL));
         ok(isequalRel(domdt,         6.914571527623e-07, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 9.926886154337e-01,  3.343177840848e-01,  4.789944431026e+00, -1.738090138239e-04, -1.505235132354e-05,  2.456223144115e-05,  2.004016516758e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            5.782022000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.209984410530e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            1.952919673236e-02, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(dmdt,         -3.093486129009e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         1.298165842561e-07, TOL));
         ok(isequalRel(domdt,        -1.214482290414e-07, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 9.977390326858e-01,  7.096896000000e-06,  5.429679160382e+00, -4.359221435156e-06, -5.454519985382e-05,  1.090900126053e-04,  1.090896255044e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            2.664000000000e-03, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         6.725800805485e-02, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            4.397108759492e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,          9.928697389680e-11, TOL));
         ok(isequalRel(didt,          3.031124826307e-08, TOL));
         ok(isequalRel(dmdt,         -1.325603345647e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         1.822046740261e-08, TOL));
         ok(isequalRel(domdt,         4.338936906528e-08, TOL));
         ok(isequalRel(del1,         -6.446921893630e-13, TOL));
         ok(isequalRel(del2,          1.431037712307e-11, TOL));
         ok(isequalRel(del3,          2.011847944584e-12, TOL));
         ok(isequalRel(xfact,        -4.375013627469e-03, TOL));
         ok(isequalRel(xlamo,         2.631376049241e+00, TOL));
         ok(isequalRel(xli,           2.631376049241e+00, TOL));
         ok(isequalRel(xni,           4.397108759492e-03, TOL));
     });

// 24208

test(' 9.999999999756e-01,  3.115225000000e-08,  2.710391608592e-01, -2.902754621049e-07, -5.482067443771e-05,  1.096413471676e-04,  1.096413454598e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            1.765000000000e-04, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         6.981317007977e-06, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            4.374997775854e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,         -2.555341579158e-08, TOL));
         ok(isequalRel(dmdt,         -9.603349062976e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         0.000000000000e+00, TOL));
         ok(isequalRel(domdt,         2.359014000576e-08, TOL));
         ...
         ok(isequalRel(xfact,        -4.375016371464e-03, TOL));
         ok(isequalRel(xlamo,         4.519114215663e+00, TOL));
         ok(isequalRel(xli,           4.519114215663e+00, TOL));
         ok(isequalRel(xni,           4.374997775854e-03, TOL));
     });

// 25954

test(' 9.999999590350e-01,  1.101576100000e-07,  1.504114277393e+00, -5.458354928034e-07, -5.481927818934e-05,  1.096385503399e-04,  1.096385443012e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            3.319000000000e-04, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         2.862339973271e-04, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            4.375109379983e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,         -3.073811485140e-08, TOL));
         ok(isequalRel(dmdt,         -1.613621211138e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         0.000000000000e+00, TOL));
         ok(isequalRel(domdt,         9.088792566710e-08, TOL));
         ...
         ok(isequalRel(xfact,        -4.375014382954e-03, TOL));
         ok(isequalRel(xlamo,         1.082634277327e+00, TOL));
         ok(isequalRel(xli,           1.082634277327e+00, TOL));
         ok(isequalRel(xni,           4.375109379983e-03, TOL));
     });

// 26900

test(' 3.669656121548e-01,  3.139223067713e-01,  2.159817024075e+00, -3.720978016674e-04, -3.226647047178e-05,  5.345251045300e-05,  4.427461125982e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            5.602877000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         1.195051373450e+00, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.973959238486e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          2.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(dedt,         -3.971152052616e-08, TOL));
         ok(isequalRel(didt,          9.978447336132e-10, TOL));
         ok(isequalRel(dmdt,          2.773996268752e-09, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -6.124174505388e-09, TOL));
         ok(isequalRel(domdt,         1.574985894206e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,        -8.752357893374e-03, TOL));
         ok(isequalRel(xlamo,         5.815472857673e+00, TOL));
         ok(isequalRel(xli,           5.815472857673e+00, TOL));
         ok(isequalRel(xni,           8.973959238486e-03, TOL));
     });

// 26975
// 28057

test(' 5.774330664585e-01,  2.352832036000e-05,  4.647183479530e+00, -3.988100801283e-06, -2.740688187581e-05,  5.481311890993e-05,  5.481247407583e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            4.850600000000e-03, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         9.552152089580e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            8.751201528747e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,         -8.158095760647e-09, TOL));
         ok(isequalRel(dmdt,         -2.274847457650e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -1.962977385408e-08, TOL));
         ok(isequalRel(domdt,         8.552991333113e-09, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 8.786504992963e-01,  3.905066339681e-01,  2.971510317983e+00, -2.120658619569e-04, -1.855950189595e-05,  2.897882708615e-05,  2.262378656488e-05,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            6.249053000000e-01, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         4.977679026688e-01, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            1.655279727416e-02, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          0.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(d5421,         0.000000000000e+00, TOL));
         ok(isequalRel(d5433,         0.000000000000e+00, TOL));
         ok(isequalRel(dedt,         -1.284368777035e-08, TOL));
         ok(isequalRel(didt,          2.182189987367e-08, TOL));
         ok(isequalRel(dmdt,         -1.266772856942e-08, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,        -1.981003275567e-08, TOL));
         ok(isequalRel(domdt,         2.122734368629e-08, TOL));
         ok(isequalRel(del1,          0.000000000000e+00, TOL));
         ok(isequalRel(del2,          0.000000000000e+00, TOL));
         ok(isequalRel(del3,          0.000000000000e+00, TOL));
         ok(isequalRel(xfact,         0.000000000000e+00, TOL));
...
test(' 9.999999994502e-01,  1.122250000000e-09,  2.407123197766e-01, -5.509538844302e-08, -5.482128209438e-05,  1.096425641272e-04,  1.096425640657e-04,',
     function () {
         var rets = dsinit(
         ...
         TOL     = 0.0000001;
         expect(31);
         ok(isequalRel(em,            3.350000000000e-05, TOL));
         ok(isequalRel(argpm,         0.000000000000e+00, TOL));
         ok(isequalRel(inclm,         3.316125578789e-05, TOL));
         ok(isequalRel(mm,            0.000000000000e+00, TOL));
         ok(isequalRel(nm,            4.374949216286e-03, TOL));
         ok(isequalRel(nodem,         0.000000000000e+00, TOL));
         ok(isequalRel(irez,          1.000000000000e+00, TOL));
         ok(isequalRel(atime,         0.000000000000e+00, TOL));
         ok(isequalRel(d2201,         0.000000000000e+00, TOL));
         ...
         ok(isequalRel(didt,         -2.947177196394e-08, TOL));
         ok(isequalRel(dmdt,         -1.045030124521e-07, TOL));
         ok(isequalRel(dndt,          0.000000000000e+00, TOL));
         ok(isequalRel(dnodt,         0.000000000000e+00, TOL));
         ok(isequalRel(domdt,         3.403399555001e-08, TOL));
         ...
         ok(isequalRel(xfact,        -4.375014405570e-03, TOL));
         ok(isequalRel(xlamo,         4.797386947630e+00, TOL));
         ok(isequalRel(xli,           4.797386947630e+00, TOL));
         ok(isequalRel(xni,           4.374949216286e-03, TOL));
     });
