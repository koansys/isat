...
// Why do we get const 72 here? We seem to use 84 elsewhere (tests/constantSpec.js)

describe("dsinit: TODO: we get 72 in here but test 84 in constantSpec", function(){
    ...
    beforeEach(function(done){
        require(["../lib/dsinit", "../lib/getgravc", "tests/testing"], function(dsinit, getgravc, testing){
            fut = dsinit;
            t=testing;
            o=null;
            c = getgravc(72); // TODO: 72 from the original tests. Why?
            done();
        });
    });

    it(" 9.800539401920e-01,  2.103967656036e-02,  3.623303527140e+00, -1.968466918871e-04, -4.620853989286e-05,  9.143969877776e-05,  9.047265431838e-05,",
       function () {
           var o = fut(
            ...
            expect(t.isEqualRel(o.em,            1.450506000000e-01, TOL));
            expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
            expect(t.isEqualRel(o.inclm,         2.000636014976e-01, TOL));
            expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
            expect(t.isEqualRel(o.nm,            5.245868658927e-03, TOL));
            expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
            ...
            expect(t.isEqualRel(o.dndt,          0.000000000000e+00, TOL));
...
it(" 4.358815257110e-01,  4.729513710532e-01,  4.621022739372e+00, -4.106209626082e-04, -3.776251664788e-05,  5.482975046298e-05,  3.980536524969e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            6.877146000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.119778813470e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.748547019630e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
...
it(" 4.289855844945e-01,  4.997148204060e-01,  4.712788660783e+00, -4.105604224204e-04, -3.869698011745e-05,  5.474139856001e-05,  3.871905129561e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.069051000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.127426846252e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.762667060363e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          2.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
...
it(" 9.862976975087e-01,  7.342528284100e-04,  5.716345999363e+00, -3.844603186866e-05, -4.732890446927e-05,  9.462305117515e-05,  9.458830617460e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            2.709710000000e-02, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.657329751109e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            5.069384722250e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
...
it(" 6.846539709542e-01,  5.355365089730e-01,  8.285461931653e-01, -3.598896383932e-04, -3.529408803158e-05,  4.810694202241e-05,  3.278563067952e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.318036000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         8.166674822762e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            9.971131604593e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.801384832532e-01,  1.336798440000e-06,  4.617827041512e-01, -1.928451076707e-06, -5.559746452923e-05,  1.111948547358e-04,  1.111947804133e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            1.156200000000e-03, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.996377411601e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            4.313874514604e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          1.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 4.680747993911e-01,  3.131887589093e-01,  4.278836976885e+00, -1.565426252795e-04, -1.357597034132e-05,  2.250191985532e-05,  1.864825807826e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            5.596327000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.083685404539e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            2.131732105901e-02, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.768540719074e-01,  6.184952661581e-01,  3.426128445555e+00, -3.244378761083e-03, -3.604476295552e-04,  4.452686665858e-04,  2.750249539548e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.864447000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         2.155725972308e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            1.077283640185e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 4.667741107229e-01,  5.508148245610e-01,  4.416489349660e+00, -4.075107416397e-04, -4.074643162103e-05,  5.461755872540e-05,  3.660538607241e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.421690000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.085156717098e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.782535528761e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          2.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
...
it(" 4.461431438481e-01,  5.687741989094e-01,  4.421379762224e+00, -4.152029536535e-04, -4.255636236536e-05,  5.589164123999e-05,  3.670280290501e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.541712000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.108345161540e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.582332516240e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          2.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
...
it(" 9.924402794872e-01,  5.268569159708e-01,  5.167015834603e+00, -3.645715464322e-04, -3.538528327605e-05,  4.867981516121e-05,  3.348460411695e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            7.258491000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.230387309486e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            9.853789469239e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 8.767351504117e-01,  9.463978197680e-01,  5.312084111370e-01, -5.081511320759e-03, -3.248271505978e-03,  1.504089035974e-03,  3.482288694116e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            9.728298000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         5.017647066558e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            3.189177226396e-04, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.926886154337e-01,  3.343177840848e-01,  4.789944431026e+00, -1.738090138239e-04, -1.505235132354e-05,  2.456223144115e-05,  2.004016516758e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            5.782022000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.209984410530e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            1.952919673236e-02, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.977390326858e-01,  7.096896000000e-06,  5.429679160382e+00, -4.359221435156e-06, -5.454519985382e-05,  1.090900126053e-04,  1.090896255044e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            2.664000000000e-03, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         6.725800805485e-02, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            4.397108759492e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          1.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.999999999756e-01,  3.115225000000e-08,  2.710391608592e-01, -2.902754621049e-07, -5.482067443771e-05,  1.096413471676e-04,  1.096413454598e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            1.765000000000e-04, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         6.981317007977e-06, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            4.374997775854e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          1.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.999999590350e-01,  1.101576100000e-07,  1.504114277393e+00, -5.458354928034e-07, -5.481927818934e-05,  1.096385503399e-04,  1.096385443012e-04,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            3.319000000000e-04, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         2.862339973271e-04, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            4.375109379983e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          1.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 3.669656121548e-01,  3.139223067713e-01,  2.159817024075e+00, -3.720978016674e-04, -3.226647047178e-05,  5.345251045300e-05,  4.427461125982e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            5.602877000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         1.195051373450e+00, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.973959238486e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          2.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
...
it(" 5.774330664585e-01,  2.352832036000e-05,  4.647183479530e+00, -3.988100801283e-06, -2.740688187581e-05,  5.481311890993e-05,  5.481247407583e-05,",
   function () {
     var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            4.850600000000e-03, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         9.552152089580e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            8.751201528747e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 8.786504992963e-01,  3.905066339681e-01,  2.971510317983e+00, -2.120658619569e-04, -1.855950189595e-05,  2.897882708615e-05,  2.262378656488e-05,",
   function () {
       var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            6.249053000000e-01, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         4.977679026688e-01, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            1.655279727416e-02, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          0.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
...
it(" 9.999999994502e-01,  1.122250000000e-09,  2.407123197766e-01, -5.509538844302e-08, -5.482128209438e-05,  1.096425641272e-04,  1.096425640657e-04,",
   function () {
       var o = fut(
...
expect(31);
expect(t.isEqualRel(o.em,            3.350000000000e-05, TOL));
expect(t.isEqualRel(o.argpm,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.inclm,         3.316125578789e-05, TOL));
expect(t.isEqualRel(o.mm,            0.000000000000e+00, TOL));
expect(t.isEqualRel(o.nm,            4.374949216286e-03, TOL));
expect(t.isEqualRel(o.nodem,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.irez,          1.000000000000e+00, TOL));
expect(t.isEqualRel(o.atime,         0.000000000000e+00, TOL));
expect(t.isEqualRel(o.d2201,         0.000000000000e+00, TOL));
